...
CurrentPageNow 	= "product_class.asp"	'当前页.
TitleName 		= "分类管理"	'此模块管理页的名字.
UnitName 		= "分类"					'此模块涉及记录的元素名.
'自定义设置.
'本地设置.
Dim CurrentTableName
CurrentTableName 	= "[CXBG_product_class]"	'此模块涉及的[表]名.
'非本地设置.
		...
		<div class="news1">
			...
			<h3>当前操作</h3>
				...
				<ul>
					...
					<li><a href="?Action=Order">&#187;一级排序操作</a></li>
					<li><a href="?Action=OrderN">&#187;子级排序操作</a></li>
				...
				<form action="<% = CurrentPageNow %>" method="get" name="deleteAction" id="deleteAction">
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td style="text-align:center;">
							<% =rsClass("TotalProductNum") %>
						</td>
						<td style="text-align:center;">
							<%
							If rsClass("isNavigation")=0 Then
							%>
							<img src="../images/no.gif" />
							<%
							ElseIf rsClass("isNavigation")=1 Then
							%>
						...
						<td style="text-align:center;">
							<%
							If rsClass("isShow")=0 Then
							%>
							<img src="../images/no.gif" />
							<%
							ElseIf rsClass("isShow")=1 Then
							%>
							<img src="../images/yes.gif" />
							<%
							End If
				...
				><!--execute=别用新版-->
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							<span style="color:#999999;"> 尺寸要求:宽332*高313 (长方形)<br />此上传图仅仅会用在“首页右下的节日专区”中展示使用，<br />如果不属于节日礼品中的二级分类，如元旦、春节、情人节等的分类，都不需要上传此图！</span>
							<br />
							<br />
							
							<a href="#" target="_blank" id="href_photo">
							<img style="border:5px #999999 solid;" src="/images/NoPic.png" width="365" height="345" onerror='this.src="/images/NoPic.png"'
							 id="src_photo"
							/></a>
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							...
							<input type="checkbox" name="isNavigation" value="1" />
					  	</td>
					  </tr>
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							...
							<input type="checkbox" name="isShow" value="1" checked="checked" />
					  	</td>
					  </tr>
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							...
							regExp=".{1,50}"
							 value="<% =Server.HtmlEncode(rsClass("classname")) %>"
                             class="input_tell"
							/>
							
							<br />&amp;nbsp;命令的使用场景图例：(当分类名不是标准的4字时，可以用此命令做微调.)
							<br />详细说明&amp;nbsp;命令的使用：&amp;nbsp;代表空格特殊命令.(&amp;nbsp;在前台表现为看不见的空格，仅仅用于占位.)
						</td>
					  </tr>
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							...
							<img style="border:5px #999999 solid;" src="<% If rsClass("photo")<>"" Then Response.Write rsClass("photo") Else Response.Write "/images/NoPic.png" %>" width="365" height="345" onerror='this.src="/images/NoPic.png"'
							 id="src_photo"
							/></a>
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							...
							<input type="checkbox" name="isNavigation" value="1" <% If rsClass("isNavigation")=1 Then Response.Write "checked=""checked""" Else Response.Write "" %> />
					  	</td>
					  </tr>
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							...
							<input type="checkbox" name="isShow" value="1" <% If rsClass("isShow")=1 Then Response.Write "checked=""checked""" Else Response.Write "" %> />
					  	</td>
					  </tr>
...
sub SaveAdd()
	...
	isNavigation=CokeShow.filtRequest(Request("isNavigation"))
	isShow=CokeShow.filtRequest(Request("isShow"))
	...
	If CokeShow.CokeClng(isNavigation)=1 Then rs("isNavigation")=CokeShow.CokeClng(isNavigation) Else rs("isNavigation")=0
	If CokeShow.CokeClng(isShow)=1 Then rs("isShow")=CokeShow.CokeClng(isShow) Else rs("isShow")=0
...
'	response.Write isNumeric(isShow)
'	response.End()
	If CokeShow.CokeClng(isNavigation)=1 Then rsClass("isNavigation")=CokeShow.CokeClng(isNavigation) Else rsClass("isNavigation")=0
	If CokeShow.CokeClng(isShow)=1 Then rsClass("isShow")=CokeShow.CokeClng(isShow) Else rsClass("isShow")=0
