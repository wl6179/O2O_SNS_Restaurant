...
CurrentPageNow 	= "GiftCertificated_edit.asp"			'当前页.
TitleName 		= "礼品券发布管理"				'此模块管理页的名字.
UnitName 		= "礼品券"					'此模块涉及记录的元素名.
'自定义设置.
'本地设置.
Dim CurrentTableName
CurrentTableName 	= "[CXBG_GiftCertificated]"		'此模块涉及的[表]名.
%>
			...
			%>
				<form action="<% = CurrentPageNow %>" method="get" name="deleteAction" id="deleteAction">
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  %>
					  <tr>
						<td colspan="8" style="color:red;">对不起，没有记录...</td>
					  </tr>
					  <%
					  End If
					  %>
