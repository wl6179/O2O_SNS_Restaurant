...
CurrentPageNow 	= "FriendlyLink.asp"	'当前页.
TitleName 		= "友情链接管理"	'此模块管理页的名字.
UnitName 		= "友情链接"					'此模块涉及记录的元素名.
'自定义设置.
'本地设置.
Dim CurrentTableName
CurrentTableName 	= "[CXBG_FriendlyLink]"	'此模块涉及的[表]名.
'非本地设置.
			...
			%>
				<form action="<% = CurrentPageNow %>" method="get" name="deleteAction" id="deleteAction">
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  %>
					  <tr>
						<td colspan="6" style="color:red;">对不起，没有记录...</td>
					  </tr>
					  <%
					  End If
					  %>
					  ...
					  <tr>
						...
						<td style="text-align:center;">
							...
							%>
								...
								<img id="src_photo<% =rsClass("classid") %>" src="<% =rsClass("photo") %>" width="50" />
								<!--begin-->
						...
						<td style="text-align:center;">
							...
							<% ="<a href="""& rsClass("DirectingLink") &""" target=""_blank"">"& rsClass("DirectingLink") &"</a>" %>
							
						</td>
                        
                        <td style="text-align:center;">
							
							<% If rsClass("isCooperativeAdvertisingString")=1 Then Response.Write "<img src=/images/yes.gif />有联合广告说明" Else Response.Write "无联合广告" %>&nbsp;
							
						</td>
                        
                        <td>
						<% If rsClass("isOnpublic")=1 Then Response.Write "<img src=/images/yes.gif />发布" Else Response.Write "<img src=/images/no.gif />不发布" %>
						&nbsp;
						</td>
			...
			%>
				...
				><!--execute=别用新版-->
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							<!--
							临时不用.
							<div dojoType="dijit.Editor" name="readme" id="readme" 
							plugins="['undo','redo','|','bold','italic','underline','strikethrough']" 
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							<span style="color:#999999;"> 尺寸要求:宽128*高50 (长方形)</span>
							<br />
							<br />
							
							<a href="#" target="_blank" id="href_photo">
							<img style="border:5px #999999 solid;" src="/images/NoPic.png" width="128" height="50" onerror='this.src="/images/NoPic.png"'
							 id="src_photo"
							/></a>
					  ...
					  <tr style="display:none;">
						...
						<td style="text-align: left;">
							...
							dojoType="dijit.form.ValidationTextBox"
							required="false"
							promptMessage="<% =UnitName %>关键字，是与广告菜品相互关联<br />的关键所在，多个关键字请以逗号隔开."
							invalidMessage="<% =UnitName %>长度必须在1-50字之内!"
							trim="true"
							lowercase="false"
							...
							regExp=".{1,50}"
                             ...
                             class="input_tell"
							/>
							<br /><span style="color:#999999;">例如：元旦狂欢20100101</span>
						</td>
					  </tr>
					  
                      <tr style="display:none;">
                        <td style="text-align: right;">
                            <input type="checkbox" name="isDirectingLink" id="isDirectingLink" value="1" onClick="DisplayTheElement('isDirectingLink_area')"
                            
                            /><label for="isDirectingLink">是否固定链接</label>
                            <br />
                            <div style="color:#999999;">(打勾将直接指向固定链接.)</div>
                        </td>
                        <td style="text-align: left;" colspan="3">
                            <!--isDirectingLink_area begin-->
                            <div id="isDirectingLink_area" style="display: none;">
                                
                                <span style="color:#999999;"> 请填写完整的链接地址</span>
                    ...
                    <tr>
						...
						<td style="text-align: left;">
							<input type="text" id="DirectingLink" name="DirectingLink"
                                dojoType="dijit.form.ValidationTextBox"
                                required="false"
                      ...
                      <tr>
                        <td style="text-align: right;">
                            <input type="checkbox" name="isCooperativeAdvertisingString" id="isCooperativeAdvertisingString" value="1" onClick="DisplayTheElement('isCooperativeAdvertisingString_area')"
                            
                            /><label for="isCooperativeAdvertisingString">是否有联合广告说明</label>
                            <br />
                            <div style="color:#999999;">(打勾将展示联合餐厅的优惠活动.)</div>
                        </td>
                        <td style="text-align: left;" colspan="3">
                            <!--isCooperativeAdvertisingString_area begin-->
                            <div id="isCooperativeAdvertisingString_area" style="display: none;">
                                
                                <span style="color:#999999;"> 请填写联合广告</span>
								...
								'创建输入框名为：description
								oFCKeditor.Create "CooperativeAdvertisingString"
								%>
                                
                                
                                
                            </div>
                            <!--isCooperativeAdvertisingString_area end-->
                        </td>
                    	...
                    	<tr>
                          ...
                          <tr>
							<td style="text-align: right;">调正对话框尺寸<br />默认为100*100</td>
							<td style="text-align: left;" colspan="3">
							宽:
							<div name="dialog_whidth" id="dialog_whidth"
                            ...
                            高:
                            <div name="dialog_height" id="dialog_height"
							dojoType="dijit.form.NumberSpinner"
							constraints="{ max:999, min:0 }"
							style="width:8em;"
							value="100"
							...
							<br />
							<span style="color:#999999;">可以自行设定友情链接对话框的尺寸</span>
							</td>
				...
				><!--execute=别用新版-->
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							...
							<img style="border:5px #999999 solid;" src="<% If rsClass("photo")<>"" Then Response.Write rsClass("photo") Else Response.Write "/images/NoPic.png" %>" width="128" height="50" onerror='this.src="/images/NoPic.png"'
							 id="src_photo"
							/></a>
					  ...
					  <tr style="display:none;">
                        <td style="text-align: right;">
                            <input type="checkbox" name="isDirectingLink" id="isDirectingLink" value="1" onClick="DisplayTheElement('isDirectingLink_area')"
                            <% If rsClass("isDirectingLink")=1 Then Response.Write " checked=""checked""" %>
                            /><label for="isDirectingLink">是否固定链接</label>
                            <br />
                            <div style="color:#999999;">(打勾将直接指向固定链接.)</div>
                        </td>
                        <td style="text-align: left;" colspan="3">
                            <!--isDirectingLink_area begin-->
                            <div id="isDirectingLink_area" style="display: <% If rsClass("isDirectingLink")=1 Then Response.Write "black" Else Response.Write "none" %>;">
                    ...
                    <tr>
                      ...
                      <tr>
                        <td style="text-align: right;">
                            <input type="checkbox" name="isCooperativeAdvertisingString" id="isCooperativeAdvertisingString" value="1" onClick="DisplayTheElement('isCooperativeAdvertisingString_area')"
                            <% If rsClass("isCooperativeAdvertisingString")=1 Then Response.Write " checked=""checked""" %>
                            /><label for="isCooperativeAdvertisingString">是否有联合广告说明</label>
                            <br />
                            <div style="color:#999999;">(打勾将展示联合餐厅的优惠活动.)</div>
                        </td>
                        <td style="text-align: left;" colspan="3">
                            <!--isCooperativeAdvertisingString_area begin-->
                            <div id="isCooperativeAdvertisingString_area" style="display: <% If rsClass("isCooperativeAdvertisingString")=1 Then Response.Write "black" Else Response.Write "none" %>;">
								...
								oFCKeditor.Height=280
								'输入框的初始值
								oFCKeditor.Value= rsClass("CooperativeAdvertisingString")
                        ...
                        <tr>
							...
							<td style="text-align: left;" colspan="3">
							宽:
							<div name="dialog_width" id="dialog_width"
							dojoType="dijit.form.NumberSpinner"
							constraints="{ max:999, min:0 }"
							style="width:8em;"
							value="<% =rsClass("dialog_width") %>"
							onClick="this.select();"
							>
							</div>
                        ...
                        <tr>
							...
							<input type="checkbox" name="isOnpublic" id="isOnpublic" value="1" <% If rsClass("isOnpublic")=1 Then Response.Write "checked=""checked""" %> /><label for="isOnpublic" style="color:#999999;"> 打勾表示<% =UnitName %>将正常显示在网站上，否则不会在网站显示.</label>
							</td>
...
sub SaveAdd()
	...
	Dim photo,keywords
	Dim isDirectingLink,DirectingLink
	Dim isOnpublic
	Dim isCooperativeAdvertisingString,CooperativeAdvertisingString
	Dim dialog_width,dialog_height
	
	photo=CokeShow.filtRequest(Request("photo"))
	keywords=CokeShow.filtRequest(Request("keywords"))
	
	isDirectingLink	=CokeShow.filtRequest(Request("isDirectingLink"))
	DirectingLink	=CokeShow.filtRequest(Request("DirectingLink"))
	
	isOnpublic		=CokeShow.filtRequest(Request("isOnpublic"))
	
	isCooperativeAdvertisingString	=CokeShow.filtRequest(Request("isCooperativeAdvertisingString"))
	CooperativeAdvertisingString	=CokeShow.filtRequest(Request("CooperativeAdvertisingString"))
	
	dialog_width	=CokeShow.filtRequest(Request("dialog_width"))
	dialog_height	=CokeShow.filtRequest(Request("dialog_height"))
	...
	If isEmpty(keywords) Or isNull(keywords) Or keywords="" Then
		rs("keywords")=""
	Else
		rs("keywords")=keywords
	End If
	
	If isNumeric(isDirectingLink) Then
		If isDirectingLink=1 Then rs("isDirectingLink")=isDirectingLink Else rs("isDirectingLink")=0
	Else
		rs("isDirectingLink")=0
	End If
	rs("DirectingLink")		=DirectingLink
	...
	If isNumeric(isCooperativeAdvertisingString) Then
		If isCooperativeAdvertisingString=1 Then rs("isCooperativeAdvertisingString")=isCooperativeAdvertisingString Else rs("isCooperativeAdvertisingString")=0
	Else
		rs("isCooperativeAdvertisingString")=0
	End If
	rs("CooperativeAdvertisingString")		=CooperativeAdvertisingString
	
	If isNumeric(dialog_width) Then
		rs("dialog_width")=CokeShow.CokeCint(dialog_width)
	Else
		rs("dialog_width")=100
	End If
	If isNumeric(dialog_height) Then
		rs("dialog_height")=CokeShow.CokeCint(dialog_height)
	Else
		rs("dialog_height")=100
	End If
...
sub SaveModify()
	...
	If isNumeric(isDirectingLink) Then
		If isDirectingLink=1 Then rsClass("isDirectingLink")=isDirectingLink Else rsClass("isDirectingLink")=0
	Else
		rsClass("isDirectingLink")=0
	End If
	rsClass("DirectingLink")		=DirectingLink
	...
	Else
		...
		End If
	End If
	rsClass("isOnpublic")		=isOnpublic
	
	If isNumeric(isCooperativeAdvertisingString) Then
		If isCooperativeAdvertisingString=1 Then rsClass("isCooperativeAdvertisingString")=isCooperativeAdvertisingString Else rsClass("isCooperativeAdvertisingString")=0
	Else
		rsClass("isCooperativeAdvertisingString")=0
	End If
	rsClass("CooperativeAdvertisingString")		=CooperativeAdvertisingString
	
	If isNumeric(dialog_width) Then
		rsClass("dialog_width")=CokeShow.CokeCint(dialog_width)
	Else
		rsClass("dialog_width")=100
	End If
	If isNumeric(dialog_height) Then
		rsClass("dialog_height")=CokeShow.CokeCint(dialog_height)
	Else
		rsClass("dialog_height")=100
	End If
