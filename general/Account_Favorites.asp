...
'变量定义区.
'(用来存储对象的变量，用全大写!)
Const maxPerPage=25							'当前模块分页设置.
Dim CurrentPageNow,TitleName,UnitName
CurrentPageNow 	= "Account_Favorites.asp"			'当前页.
TitleName 		= "会员菜品收藏管理"				'此模块管理页的名字.
UnitName 		= "会员菜品收藏"					'此模块涉及记录的元素名.
'自定义设置.
'本地设置.
Dim CurrentTableName
CurrentTableName 	= "[CXBG_account_Favorite]"		'此模块涉及的[表]名.
%>
		...
		<div class="news2" style="display: none;">
			...
			<p>
					...
					<select name="TypeSearch" id="TypeSearch">
					    ...
					    <option value="topic" >按礼品券名查询</option>
...
<%' ="<br />StartDateValid:"& request("StartDateValid") %>
<%' ="<br />StopDateValid:"& request("StopDateValid") %>
...
Sub Main()
	...
	Select Case ExecuteSearch
		Case 0
			sql="SELECT TOP 500 * FROM [View_CXBG_Favorite_ProductInformation] WHERE deleted=0 ORDER BY id DESC"
			strGuide=strGuide & "所有"& UnitName
		Case 1
			sql="SELECT TOP 500 * FROM "& CurrentTableName &" WHERE deleted=0 ORDER BY iis DESC,details_orderid DESC,id DESC"
			strGuide=strGuide & "访问量最多的前500个"& UnitName
...
'							'获取对应的菜品信息.
'							Set rs222=CONN.Execute("SELECT TOP 1 * FROM [CXBG_product] WHERE id="& RS("product_id") &"")
...
'							End If
					  ...
					  <tr>
						...
						<td style="text-align:center;">
							<a class="abg08" href="/ChineseDish/ChineseDishInformation.Welcome?CokeMark=<% =CokeShow.AddCode_Num( RS("product_id") ) %>" target="_blank"  title="<% =RS("ProductName") %>"><img src="<% If RS("Photo")<>"" Then Response.Write RS("Photo") Else Response.Write "/images/NoPic.png" %>" width="40" height="40" /></a>
							&nbsp;
						</td>
                        ...
                        <td>
						<strong style="font-size:14px; font-family: Georgia, 'Times New Roman', Times, serif; color:#F39;"><% =Coke.ShowProductChineseDish_Taste_Num( RS("product_id") ) %></strong> 分
						&nbsp;
						</td>
                        
                        
                        <td><% =Coke.ShowProductChineseDish_DiningArea_Num( RS("product_id") ) %>&nbsp;</td>
                        <td><% =Coke.ShowProductChineseDish_Service_Num( RS("product_id") ) %>&nbsp;</td>
                        
                        
                        
                        <td><% =Coke.ShowProductChineseDish_ConsumePerPerson_Num( RS("product_id") ) %>&nbsp;</td>
                        
                        <td style="text-align:center;">
                        	<span class="xxright">
                                <ul class="rating">
                                <li class="current-rating" style="width:<% =Coke.ShowProductStarRating_Num( RS("product_id") ) * 20 %>px"></li>
                                
                                </ul>
                            </span>
                        </td>
						
						<td><% =RS("ComeIntoTheMarketDate") %>&nbsp;</td>
                        <td style="font-weight:bold;"><% =RS("Account_LoginID") %>&nbsp;</td>
			...
			%>
				...
				-->
						...
						<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							<td style="text-align: right;">礼品券名</td>
							<td style="text-align: left;" colspan="3">
							<input type="text" id="topic" name="topic"
							dojoType="dijit.form.ValidationTextBox"
							required="true"
							propercase="true"
							promptMessage="礼品券名为必填项."
							invalidMessage="礼品券名长度必须在1-50之内."
							trim="true"
							lowercase="false"
							regExp=".{0,50}"
							 value=""
						  ...
						  <tr style="display:none;">
							...
							<select name="details_class_id" id="details_class_id"
							  ...
							  >
								<%
								'Call CokeShow.Option_ID("[CXBG_DiningArea_class]","",888,0,"classid","classname",True)
								%>
                                <% Call CokeShow.ClassOption_classid("[CXBG_DiningArea_class]","",0,0) %>
							  </select>
                          ...
                          <tr>
							<td style="text-align: right;">扣除积分数</td>
							<td style="text-align: left;" colspan="3">
                                ...
                                <span style="color:#999999;"> 例如：3-，默认为 1-。设置兑换礼品券将会扣除多少积分数。</span>
							</td>
                          ...
                          <tr>
							...
							<td style="text-align: left;" colspan="3">
									<label for="StartDateValid">起始日期</label>
									<div id="StartDateValid" name="StartDateValid"
									dojoType="dijit.form.DateTextBox"
									required="false"
									constraints="{min:'1982-01', max:'2020-01', datePattern:'yyyy-MM-dd'}"
									promptMessage="请选择起始日期."
									...
									&nbsp;&nbsp;——————&nbsp;&nbsp;
									<label for="StopDateValid">结束日期</label>
									<div id="StopDateValid" name="StopDateValid"
									dojoType="dijit.form.DateTextBox"
									required="false"
									constraints="{min:'<% =CokeShow.filt_DateStr( DateAdd("d",1, Date()) ) %>', max:'2020-01', datePattern:'yyyy-MM-dd'}"
									promptMessage="请选择结束日期."
									invalidMessage="Invalid Service Date."
									style="width:100px;"
                                    class="input_tell"
									>
						  ...
						  <tr>
							...
							<td style="text-align: left;" colspan="3">
								<span style="color:#999999;"> 尺寸要求:宽500*285 (长方形)</span>
								<br />
								<br />
								
								<a href="#" target="_blank" id="href_photo">
								<img style="border:5px #999999 solid;" src="/images/NoPic.png" width="500" height="285" onerror='this.src="/images/NoPic.png"'
								 id="src_photo"
								/></a>
                          ...
                          <tr>
							...
							<td style="text-align: left;" colspan="3">
								<span style="color:#999999;"> 尺寸要求:宽500*300 (长方形)</span>
								<br />
								<br />
								
								<a href="" target="_blank" id="href_photoPrint">
								<img style="border:5px #999999 solid;" src="/images/NoPic.png" width="500" height="300" onerror='this.src="/images/NoPic.png"'
								 id="src_photoPrint"
								/></a>
								
								<button type="button" 
								dojoType="dijit.form.Button"
								onclick="ShowDialog('<img src=/images/up.gif />修改图片','../upload/index.asp?Action=Add&controlStr=Print','width:300px;height:200px;');"
								>
								&nbsp;点击开始上传&nbsp;
								</button>
								
								<div id="div_photo">
								<input type="text" id="value_photoPrint" name="photoPrint"
								dojoType="dijit.form.ValidationTextBox"
								required="false"
								promptMessage="请上传图片."
								invalidMessage="必须在250长度之内！例如：/uploadimages/cokeshow.com.cn20097131746850193.png"
						  ...
						  <tr style="display:none;">
							<td style="text-align: right;">礼品券展示图片文字描述</td>
							<td style="text-align: left;" colspan="3">
							...
							invalidMessage="礼品券展示图片文字描述长度必须在1-50之内."
							trim="true"
							lowercase="false"
							regExp=".{0,50}"
							 value=""
						...
						<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
						  ...
						  <tr style="display:none;">
							...
							<select name="details_class_id" id="details_class_id"
							  ...
							  >
								<%
								'Call CokeShow.Option_ID("[CXBG_DiningArea_class]","",888,RS("details_class_id"),"classid","classname",True)
								%>
                                <% Call CokeShow.ClassOption_classid("[CXBG_DiningArea_class]","",0,RS("details_class_id")) %>
							  </select>
							 <span style="color:#999999;">必须选择.</span>
							</td>
                          ...
                          <tr>
							...
							<td style="text-align: left;" colspan="3">
									...
									class="input_tell"
                                    style="width:100px;"
									value="<% =CokeShow.filt_DateStr(RS("StartDateValid")) %>"
									>
									</div>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<label for="StopDateValid">结束日期</label>
									...
									class="input_tell"
                                    style="width:100px;"
									value="<% =CokeShow.filt_DateStr(RS("StopDateValid")) %>"
									>
									</div>
							</td>
						  ...
						  <tr>
							...
							<!--<label for="StartDateValid">起始促销日期</label>
									<div id="StartDateValid" name="StartDateValid"
									dojoType="dijit.form.DateTextBox"
									required="false"
									constraints="{min:'<% =DateAdd("d",-1, CokeShow.filt_DateStr(Date())) %>', max:'2020-01', datePattern:'yyyy-MM-dd'}"
						  ...
						  <tr>
							...
							<td style="text-align: left;" colspan="4">
								...
								<br />
								<br />
								<textarea name="logtext" id="logtext"><% =RS("logtext") %></textarea>
						  ...
						  <tr>
							...
							<td style="text-align: left;" colspan="3">
								...
								<img style="border:5px #999999 solid;" src="<% If RS("photo")<>"" Then Response.Write RS("photo") Else Response.Write "/images/NoPic.png" %>" width="500" height="285" onerror='this.src="/images/NoPic.png"'
								 id="src_photo"
								/></a>
                          ...
                          <tr>
							...
							<td style="text-align: left;" colspan="3">
								...
								<a href="<% =RS("photoPrint") %>" target="_blank" id="href_photoPrint">
								<img style="border:5px #999999 solid;" src="<% If RS("photoPrint")<>"" Then Response.Write RS("photoPrint") Else Response.Write "/images/NoPic.png" %>" width="500" height="300" onerror='this.src="/images/NoPic.png"'
								 id="src_photoPrint"
								/></a>
...
Sub SaveAdd()
	...
	Dim isRecommend
	Dim jifen
	Dim StartDateValid,StopDateValid,photoPrint
	...
	StartDateValid			=CokeShow.filtRequest(Request("StartDateValid"))
	StopDateValid			=CokeShow.filtRequest(Request("StopDateValid"))
	photoPrint				=CokeShow.filtRequest(Request("photoPrint"))
	
	'验证
	If topic="" Then
		FoundErr=True
		ErrMsg=ErrMsg &"<br><li>礼品券名不能为空！</li>"
	Else
		If CokeShow.strLength(topic)>50 Then
			FoundErr=True
			ErrMsg=ErrMsg &"<br><li>礼品券名长度不能大于50个字符！</li>"
		Else
			topic=topic
		End If
	End If
...
'		ErrMsg=ErrMsg &"<br><li>正文不能为空！</li>"
		logtext=""
	Else
		If CokeShow.strLength(logtext)>4000 Then
			FoundErr=True
			ErrMsg=ErrMsg &"<br><li>正文长度不能大于4000个字符！</li>"
		Else
			logtext=logtext
		End If
	End If
...
'	End If
	...
	Else
		If isDate(StartDateValid) Then
			
		Else
			FoundErr=True
			ErrMsg=ErrMsg &"<br><li>当前起始日期格式不对！</li>"
		End If
	End If
	
	If StopDateValid="" Then
		
		
	Else
		If isDate(StopDateValid) Then
			
		Else
			FoundErr=True
			ErrMsg=ErrMsg &"<br><li>当前结束日期格式不对！</li>"
		End If
	End If
	
	If photoPrint="" Or isNull(photoPrint) Or isEmpty(photoPrint) Then
		photoPrint=""
		
	Else
		If Len(photoPrint)>10 Then
	...
	RS.AddNew
		...
		If StartDateValid<>"" Then RS("StartDateValid")	=StartDateValid
		If StopDateValid<>"" Then RS("StopDateValid")	=StopDateValid
		RS("photoPrint")			=photoPrint
