...
CurrentPageNow 	= "advertisement_main.asp"	'当前页.
TitleName 		= "首页大广告管理"	'此模块管理页的名字.
UnitName 		= "首页大广告"					'此模块涉及记录的元素名.
'自定义设置.
'本地设置.
Dim CurrentTableName
CurrentTableName 	= "[CXBG_advertisement_main]"	'此模块涉及的[表]名.
'非本地设置.
				...
				><!--execute=别用新版-->
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							<span style="color:#999999;"> 尺寸要求:宽400*高200 (长方形)</span>
							<br />
							<br />
							
							<a href="#" target="_blank" id="href_photo">
							<img style="border:5px #999999 solid;" src="/images/NoPic.png" width="400" height="200" onerror='this.src="/images/NoPic.png"'
							 id="src_photo"
							/></a>
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							...
							<img style="border:5px #999999 solid;" src="<% If rsClass("photo")<>"" Then Response.Write rsClass("photo") Else Response.Write "/images/NoPic.png" %>" width="400" height="200" onerror='this.src="/images/NoPic.png"'
							 id="src_photo"
							/></a>
