...
CurrentPageNow 	= "Game_edit.asp"			'当前页.
TitleName 		= "游戏发布管理"				'此模块管理页的名字.
UnitName 		= "游戏"					'此模块涉及记录的元素名.
'自定义设置.
'本地设置.
Dim CurrentTableName
CurrentTableName 	= "[CXBG_Game]"		'此模块涉及的[表]名.
%>
		...
		<div class="news2" style="display: none;">
			...
			<p>
					...
					<select name="TypeSearch" id="TypeSearch">
					    ...
					    <option value="topic" >按游戏名称查询</option>
				...
				-->
						...
						<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							...
							required="true"
							propercase="true"
							promptMessage="游戏名称为必填项."
							invalidMessage="游戏名称长度必须在1-50之内."
							trim="true"
							lowercase="false"
							regExp=".{0,50}"
							 value=""
                          ...
                          <tr>
							...
							<td style="text-align: left;" colspan="3">
                                ...
                                <span style="color:#999999;"> 例如：3+，默认为 1+。设置玩游戏将会得到多少积分数。</span>
							</td>
						  ...
						  <tr>
							...
							<td style="text-align: left;" colspan="3">
								<span style="color:#999999;"> 尺寸要求:宽385*148 (长方形)</span>
								<br />
								<br />
								
								<a href="#" target="_blank" id="href_photo">
								<img style="border:5px #999999 solid;" src="/images/NoPic.png" width="385" height="148" onerror='this.src="/images/NoPic.png"'
								 id="src_photo"
								/></a>
						  ...
						  <tr style="display:none;">
							<td style="text-align: right;">游戏图片文字描述</td>
							<td style="text-align: left;" colspan="3">
							...
							invalidMessage="游戏图片文字描述长度必须在1-50之内."
							trim="true"
							lowercase="false"
							regExp=".{0,50}"
							 value=""
						...
						<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							...
							<td style="text-align: left;" colspan="3">
								...
								<img style="border:5px #999999 solid;" src="<% If RS("photo")<>"" Then Response.Write RS("photo") Else Response.Write "/images/NoPic.png" %>" width="385" height="148" onerror='this.src="/images/NoPic.png"'
								 id="src_photo"
								/></a>
...
Sub SaveAdd()
	...
	If topic="" Then
		FoundErr=True
		ErrMsg=ErrMsg &"<br><li>游戏名称不能为空！</li>"
	Else
		If CokeShow.strLength(topic)>50 Then
			FoundErr=True
			ErrMsg=ErrMsg &"<br><li>游戏名称长度不能大于50个字符！</li>"
		Else
			topic=topic
		End If
	End If
