...
CurrentPageNow 	= "DiningArea_class.asp"	'当前页.
TitleName 		= "餐厅环境图片分类管理"	'此模块管理页的名字.
UnitName 		= "餐厅环境图片分类"					'此模块涉及记录的元素名.
'自定义设置.
'本地设置.
Dim CurrentTableName
CurrentTableName 	= "[CXBG_DiningArea_class]"	'此模块涉及的[表]名.
'非本地设置.
