...
CurrentPageNow 	= "log.asp"			'当前页.
TitleName 		= "日志管理"				'此模块管理页的名字.
UnitName 		= "日志"					'此模块涉及记录的元素名.
'自定义设置.
'本地设置.
Dim CurrentTableName
CurrentTableName 	= "[CXBG_log]"		'此模块涉及的[表]名.
%>
...
'记入日志.
Call CokeShow.AddLog("删除操作：删除了日志"& strID, "UPDATE "& CurrentTableName &" SET deleted=1 WHERE id="& strID)
