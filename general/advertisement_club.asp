...
CurrentPageNow 	= "advertisement_club.asp"	'当前页.
TitleName 		= "会员Club广告发布管理"	'此模块管理页的名字.
UnitName 		= "会员Club广告"					'此模块涉及记录的元素名.
'自定义设置.
'本地设置.
Dim CurrentTableName
CurrentTableName 	= "[CXBG_advertisement_club]"	'此模块涉及的[表]名.
'非本地设置.
	...
	<div class="newsContainer">
		...
		<div class="news1">
			...
			<h3>相关管理项目</h3>
				...
				<p>
					<!--#include file="menu_advertisement.asp"-->
				</p>
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
                        ...
                        <td style="text-align:center;">
							...
							<% If rsClass("isDirectingLink")=1 Then Response.Write "<img src=/images/yes.gif />是固定链接：<a href="""& rsClass("DirectingLink") &""" target=""_blank"">点击</a>" Else Response.Write "无固定链接" %>&nbsp;
				...
				><!--execute=别用新版-->
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							<span style="color:#999999;"> 尺寸要求:宽204*高125 (长方形)</span>
							<br />
							<br />
							
							<a href="#" target="_blank" id="href_photo">
							<img style="border:5px #999999 solid;" src="/images/NoPic.png" width="204" height="125" onerror='this.src="/images/NoPic.png"'
							 id="src_photo"
							/></a>
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							...
							regExp=".{1,50}"
                             ...
                             class="input_tell"
							/>
							<br /><span style="color:#999999;">例如：五月寿星专享礼物20100501</span>
						</td>
					  </tr>
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td style="text-align: left;">
							...
							<img style="border:5px #999999 solid;" src="<% If rsClass("photo")<>"" Then Response.Write rsClass("photo") Else Response.Write "/images/NoPic.png" %>" width="204" height="125" onerror='this.src="/images/NoPic.png"'
							 id="src_photo"
							/></a>
