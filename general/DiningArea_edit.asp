...
CurrentPageNow 	= "DiningArea_edit.asp"			'当前页.
TitleName 		= "餐厅环境图片管理"				'此模块管理页的名字.
UnitName 		= "餐厅环境图片"					'此模块涉及记录的元素名.
'自定义设置.
'本地设置.
	...
	<div class="newsContainer">
		...
		<div class="news1">
			...
			<h3>相关管理项目</h3>
				...
				<p>
					<!--#include file="menu_DiningArea.asp"-->
				</p>
				...
				<form action="<% = CurrentPageNow %>" method="get" name="deleteAction" id="deleteAction">
					...
					<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td><% =CokeShow.otherField("[CXBG_DiningArea_class]",RS("details_class_id"),"classid","classname",True,0) %>&nbsp;</td>
				...
				-->
						...
						<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							...
							<td style="text-align: left;" colspan="3">
								<span style="color:#999999;"> 尺寸要求:宽600*600 (正方形)</span>
								<br />
								<br />
								
								<a href="#" target="_blank" id="href_photo">
								<img style="border:5px #999999 solid;" src="/images/NoPic.png" width="600" height="600" onerror='this.src="/images/NoPic.png"'
								 id="src_photo"
								/></a>
						  ...
						  <tr style="display:none;">
							<td style="text-align: right;">餐厅环境图片文字描述</td>
							<td style="text-align: left;" colspan="3">
							...
							invalidMessage="餐厅环境图片文字描述长度必须在1-50之内."
							trim="true"
							lowercase="false"
							regExp=".{0,50}"
							 value=""
						...
						<table width="auto" id="listGo" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							...
							<td style="text-align: left;" colspan="3">
								...
								<img style="border:5px #999999 solid;" src="<% If RS("photo")<>"" Then Response.Write RS("photo") Else Response.Write "/images/NoPic.png" %>" width="600" height="600" onerror='this.src="/images/NoPic.png"'
								 id="src_photo"
								/></a>
