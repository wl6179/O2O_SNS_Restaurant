            ...
            <li>
			 ...
			 <p class="hypl_hyp">
			   ...
			   <span class="waith100"><%
				...
				Next
				%></span>
			   <!--<span class="waith50"><a class="button_img47" href="javascript:return false;" onclick="ShowDialog('<span style=color:black;>点评</span>','/_include/Public/View_RemarkOnAndProductInfor.Welcome?id=<% =rsMemberCommentsArea_Code("id") %>','width:500px;height:400px;','');">查看</a></span>	-->
               <span class="waith50"><a class="button_img47" href="/ChineseDish/ChineseDishInformation.Welcome?CokeMark=<% =CokeShow.AddCode_Num( rsMemberCommentsArea_Code("product_id") ) %>#RemarkOnArea_start" target="_blank">查看</a></span> 
			 </p>
		   </li>
          <%
