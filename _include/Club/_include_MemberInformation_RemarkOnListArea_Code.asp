...
'接收参数.
MemberInformation_RemarkOnListArea_Code_maxPerPage			=18
MemberInformation_RemarkOnListArea_Code_CurrentTableName 	="[CXBG_account_RemarkOn]"		'此模块涉及的[表]名.
MemberInformation_RemarkOnListArea_Code_CurrentPageNow 	="/Club/MembersInformation.Welcome?CokeMark="& CokeShow.DecodeURL(Request("CokeMark"))
MemberInformation_RemarkOnListArea_Code_UnitName			="点评"
...
%>
        ...
        %>
            <ul class="tjzjdp_sjym_hypl"><li><img src="/images/ico/small/emotion_unhappy.png" /> 暂时还没有会员点评菜品哦 ... ... <a href="/ChineseDish/ChineseDish.Welcome?StarRating=True">立刻参与点评</a></li></ul>
        <%
        End If
        %>
       <%
        ...
        %>
         <li>
	       <table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
               <td width="25%" rowspan="3" valign="top"><a class="abg08" href="/ChineseDish/ChineseDishInformation.Welcome?CokeMark=<% =CokeShow.AddCode_Num( MemberInformation_RemarkOnListArea_Code_rsTmp_account_information("id") ) %>" target="_blank"  title="<% =MemberInformation_RemarkOnListArea_Code_rsTmp_account_information("ProductName") %>"><img src="<% If MemberInformation_RemarkOnListArea_Code_rsTmp_account_information("Photo")<>"" Then Response.Write MemberInformation_RemarkOnListArea_Code_rsTmp_account_information("Photo") Else Response.Write "/images/NoPic.png" %>" width="80" height="80" /></a></td>
               <td width="49%" class="coloreee">
               <!--<a class="fontred_a" href="/Club/MembersInformation.Welcome?CokeMark=<% =CokeShow.AddCode_Num( RS("id") ) %>"><% =RS("cnname") %></a>-->
               点评了：<a class="" style=" color: #F30" href="/ChineseDish/ChineseDishInformation.Welcome?CokeMark=<% =CokeShow.AddCode_Num( MemberInformation_RemarkOnListArea_Code_rsTmp_account_information("id") ) %>" target="_blank"  title="<% =MemberInformation_RemarkOnListArea_Code_rsTmp_account_information("ProductName") %>"><% =MemberInformation_RemarkOnListArea_Code_rsTmp_account_information("ProductName") %></a>
               </td>
